...
exports._sqlUtilTestsAll = {
    ...
    'foo2: `save` (update) works': async (db) => {
        const table = dao2(db);
        let data = await table.save({
            id1: 1,
            id2: 2,
